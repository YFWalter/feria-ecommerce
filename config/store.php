...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Valores por defecto de la tienda
    |--------------------------------------------------------------------------
    | Se usan cuando la clave no fue guardada en la tabla `settings`.
    */
    'defaults' => [
        'site_name'       => 'Feria',
        'logo_path'       => null,
        'theme_color'     => 'amber',
        'hero_title'      => 'Tu bazar online',
        'hero_highlight'  => 'con todo lo que necesitás',
        'hero_text'       => 'Encontrá artículos únicos y variados. Calidad a buen precio, directo a tu puerta.',
    ...
    |--------------------------------------------------------------------------
    | Cada tema define la paleta (tonos 50–950) en formato "R G B", que se
    | inyecta como variables CSS para el color `primary` de Tailwind.
    */
    'themes' => [
        'amber' => [
            'label' => 'Ámbar',
